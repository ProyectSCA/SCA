<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Mobiliario.aspx.cs" Inherits="SCA.Vistas.Activos.Mobiliario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading"><font color="grey"><label class="bold">Ingreso de Mobiliario</label></font></div>
            ...
            <form class="form-horizontal" runat="server">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="inputAccesorio" class="col-lg-2 control-label">Mobiliario</label>
                         <div class="col-lg-10">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-lg-10">                     
                            <asp:TextBox id="TxtADescripcion" TextMode="multiline" Columns="50" Rows="5" cssclass="form-control" runat="server" />
                        </div>
                    </div>
                    <div class="form-group">
